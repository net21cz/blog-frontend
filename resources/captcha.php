...
class CaptchaSecurityImage {
  ...
  private function generateCode($length, $possible = '23456789bcdfghkmnpqrstvwxyz') {
    $code = '';                                                              	
  	for ($i = 0; $i < $length; $i++) { 
  ...
  function __construct($width, $height, $characters, $font_size) {
  	...
  	$colors = [
  		...
  		imagecolorallocate($im, 51, 153, 102),
...
$captcha = new CaptchaSecurityImage($width, $height, $characters, $font_size);